 ...
 * Class TwitterParser
 */
class TwitterParser extends BaseParser implements ParserInterface
{
    ...
    protected function parseHtml(LinkInterface $link)
    {
        ...
        $cover = '<blockquote class="twitter-tweet"><p lang="en" dir="ltr">'.$description.'</p>&mdash; '.$title.' <a href="'.$link->getUrl().'">Link to tweet</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>';
